...
![Krona chart showing taxonomic composition of sample 1 assembled via Raven](figures/krona_1.png){#fig-krona1 width="65%"}

Krona output of workflow with no assembly of sample 1:

![Krona chart showing taxonomic composition of sample 1 alternative workflow (no assembly)](figures/krona_1_alt.png){#fig-krona1-alt width="65%"}
